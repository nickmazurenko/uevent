...
export default function EventsDescription(props: { className?: string }) {
  return (
    <div className={`relative ${props.className}`}>
      <img
        src="https://res.cloudinary.com/dg40lzqln/image/upload/v1681130040/unsplash_7VXfVi-Krok_gsmrjv.png"
        alt="your-image-alt"
        className="brightness-[0.65] blur-small w-screen h-full object-cover"
      />
      <div className="sm:absolute lg:inset-0 bottom-0 flex items-center justify-start">
        <div className="p-8 max-w-4xl mx-auto gap-5 flex flex-col lg:w-2/3">
          <svg
          ...
          <div className="absolute inset-y-28 inset-x-2 md:inset-0 md:relative flex flex-col text-ueventText font-extrabold h-full lg:text-6xl text-xl">
            <span className="">ALL AVAILABLE EVENTS</span>
            <span className="">FIND YOURS</span>
            <span className="opacity-70">ALL AVAILABLE EVENTS</span>
            <span className="opacity-70">FIND YOURS</span>
            <span className="opacity-40">ALL AVAILABLE EVENTS</span>
            <span className="opacity-40">FIND YOURS</span>
            <span className="opacity-20">ALL AVAILABLE EVENTS</span>
            <span className="opacity-20">FIND YOURS</span>
            <span className="opacity-10 hidden md:block">ALL AVAILABLE EVENTS</span>
            <span className="opacity-10 hidden md:block">FIND YOURS</span>
            <span className="opacity-5 hidden md:block">ALL AVAILABLE EVENTS</span>
            <span className="opacity-5 hidden md:block">FIND YOURS</span>
          </div>
        </div>
