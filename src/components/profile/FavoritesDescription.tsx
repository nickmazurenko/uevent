export default function FavoritesDescription(props: { className?: string }) {
  return (
    <div className={`relative ${props.className}`}>
      ...
      />
      <div className="sm:absolute md:inset-0 bottom-0 flex items-center justify-start">
        <div className="p-8 max-w-4xl mx-auto gap-5 flex flex-col lg:w-2/3">
          ...
          <div className="absolute inset-y-28 inset-x-2 md:inset-0 md:relative flex flex-col text-ueventText font-extrabold h-full lg:text-6xl text-xl">
            <span className="">ALL FAVORITE EVENTS</span>
            <span className="">JOIN NOW</span>
            <span className="opacity-70">ALL FAVORITE EVENTS</span>
            <span className="opacity-70">JOIN NOW</span>
            <span className="opacity-40">ALL FAVORITE EVENTS</span>
            <span className="opacity-40">JOIN NOW</span>
            <span className="opacity-20">ALL FAVORITE EVENTS</span>
            <span className="opacity-20">JOIN NOW</span>
            <span className="opacity-10 hidden md:block">
              ALL FAVORITE EVENTS
            </span>
            <span className="opacity-10 hidden md:block">JOIN NOW</span>
            <span className="opacity-5 hidden md:block">
              ALL FAVORITE EVENTS
            </span>
            <span className="opacity-5 hidden md:block">JOIN NOW</span>
          </div>
        </div>
